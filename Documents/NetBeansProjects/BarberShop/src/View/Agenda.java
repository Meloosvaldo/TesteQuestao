...
public class Agenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(LabelAgenda, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 60, 150, 60));

        LabelId.setForeground(new java.awt.Color(255, 255, 255));
        LabelId.setText("Id");
        getContentPane().add(LabelId, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, -1, -1));

        LabelCliente.setForeground(new java.awt.Color(255, 255, 255));
        LabelCliente.setText("Cliente");
        getContentPane().add(LabelCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 190, -1, -1));
        ...
        getContentPane().add(LabelData, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 340, -1, -1));

        LabelHora.setForeground(new java.awt.Color(255, 255, 255));
        LabelHora.setText("Hora");
        getContentPane().add(LabelHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, -1, -1));

        LabelObservacao.setForeground(new java.awt.Color(255, 255, 255));
        LabelObservacao.setText("Observação");
        getContentPane().add(LabelObservacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, -1, -1));
        ...
        getContentPane().add(TextId, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 130, 280, 40));

        getContentPane().add(jComboboxCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 180, 280, 40));
        ...
        getContentPane().add(jComboBoxServico, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 280, 40));
        ...
        getContentPane().add(TextValor, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 280, 40));
        ...
        getContentPane().add(TextFormatedData, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 330, 280, 40));
        ...
        getContentPane().add(TextFormatedHora, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 380, 280, 40));

        TextObservacao.setColumns(20);
        TextObservacao.setRows(5);
        jScrollPane2.setViewportView(TextObservacao);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 130, 390, 230));
        ...
        getContentPane().add(ButtonAgendar, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 370, 390, 60));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 440, 830, 200));

        LabelAgendaPainelFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/imagens/Agenda-PainelFundo.png"))); // NOI18N
        getContentPane().add(LabelAgendaPainelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 960, 670));

        LabelAgendaFundo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/imagens/AgendaFundo.png"))); // NOI18N
        LabelAgendaFundo.setBorder(new javax.swing.border.MatteBorder(null));
        getContentPane().add(LabelAgendaFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-110, -40, 1280, 890));
    ...
    public JComboBox<String> getjCombooboxServico() {
        return jComboBoxServico;
    }

    public void setjCombooboxServico(JComboBox<String> jCombooboxServico) {
        this.jComboBoxServico = jCombooboxServico;
    }
